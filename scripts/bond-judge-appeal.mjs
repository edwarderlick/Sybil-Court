...
const bond = asRecord(await call("get_bond_status", ["CASE-0003"]));
...
const appealerCredit = asRecord(
  await call("get_credit", ["0xba5fe8c391CcD7547C76ABd4D7BB7b623aaeC1Bb"]),
);
