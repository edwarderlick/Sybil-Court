...
export const policyDraft = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Appeals against Tier A classification require a minimum stake of 500 SYB tokens. The decentralized jury protocol will evaluate on-chain identity primitives (Gitcoin Passport > 20) as mitigating factors.",
    },
  ],
  confidence: [
...
export const featuredCase = {
  ...
  valueAtRisk: "45,000 SC",
  window: "14:22:09",
  windowSeconds: 14 * 3600 + 22 * 60 + 9,
  sharedIps: "14",
  appealStake: "5,000 SC",
  verdict: [
